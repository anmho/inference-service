...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/anmho/inference/gen/inference/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	GreetServiceName = "protos.v1.GreetService"
)
...
const (
	...
	GreetServiceGreetProcedure = "/protos.v1.GreetService/Greet"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	greetServiceServiceDescriptor     = v1.File_inference_v1_proto_inference_service_proto.Services().ByName("GreetService")
	greetServiceGreetMethodDescriptor = greetServiceServiceDescriptor.Methods().ByName("Greet")
)

// GreetServiceClient is a client for the protos.v1.GreetService service.
type GreetServiceClient interface {
	Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error)
}

// NewGreetServiceClient constructs a client for the protos.v1.GreetService service. By default,
...
// Greet calls protos.v1.GreetService.Greet.
...
// GreetServiceHandler is an implementation of the protos.v1.GreetService service.
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/protos.v1.GreetService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("protos.v1.GreetService.Greet is not implemented"))
}
